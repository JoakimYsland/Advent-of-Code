...
def get_remapping(signal_patterns):
	solution = [''] * 7
	pattern_dict = {}
...
def run(run_title, input_file):
	...
	for line in input_file:
		...
		remapping = get_remapping(signal_patterns)

		display_value = ''
		for digit in output_value:
			display_value += remapping[''.join(sorted(digit))]
		total_display_value += int(display_value)

	print(run_title, "total_display_value:", total_display_value)
